...
class AsteroidAdapter(private val onClickListener: OnClickListener) :androidx.recyclerview.widget.ListAdapter<Asteroid,AsteroidAdapter.AsteroidViewHolder>(DiffCallback){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): AsteroidViewHolder {
        return AsteroidViewHolder(AstroidListItemBinding.inflate(LayoutInflater.from(parent.context),parent,false))
    }
    ...
    class AsteroidViewHolder(private var binding: AstroidListItemBinding) :
